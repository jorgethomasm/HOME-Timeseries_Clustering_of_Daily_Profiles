...
# from: 2016-05-12 00:00:00 idx 4969

# to:   2016-09-28 23:00:00 idx 6096

df_train <- df_train[-seq(4969, 6096, 1), ]

row.names(df_train) <- seq(1, nrow(df_train), 1)

# save(df_train, file = "./data_examples/sub_20151012_20161011_UTC.Rdata")
